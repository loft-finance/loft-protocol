...
import {ILoftIncentivesController} from '../../interfaces/ILoftIncentivesController.sol';
...
contract LendingPoolConfigurator is VersionedInitializable, ILendingPoolConfigurator {
  ...
  function _initReserve(ILendingPool pool, InitReserveInput calldata input) internal {
    ILoftIncentivesController incentivesController =
      ILoftIncentivesController(input.incentivesController);
    ...
    // stableDebt currrent is not added to incentives controller
